...
# Modified again by Douglas Franz
# 
...
# example (Doug) ################################################
# THIS SCRIPT WAS MADE FOR ORCA BUT I GUESS IT WOULD WORK WITH 
# ANY .cube OUTPUT FROM QM PROGRAMS
#
# 1) After orca job is done, make the .cube files using orca_plot 
#    with desired methods:
#       /work/d/dfranz/orca/orca_plot orca.gbw -i
#       e.g. 1 -> 2 for e- density; 1 -> 1 for molecular orbitals
#           5 -> 7 for .cube output
#           10 to run
#           11 to exit
# 2) run this script in the directory with .cube files
#       bash vmd-orb.sh [2 or 3]
# 3) run VMD using the XYZ of the system and output of the script
#       vmd orca.xyz -e load_all_plt.vmd
#################################################################
